...
namespace MethodParameters
{
    public partial class Form1 : Form
    {
        ...
        private void testButton_Click(object sender, EventArgs e)
        {
            ...
            int num1 = Convert.ToInt32(q1Num1Input.Text);
            int num2 = Convert.ToInt32(q1Num2Input.Text);
            Add(num1, num2);
            ...
            string name = Convert.ToString(userInput.Text);
            int pin = Convert.ToInt32(pinInput.Text);
        ...
        public void WelcomeUser(string name, int pin)
        {
            ...
            {
                q3Output.Text = "Incorrect PIN or Name";
            }
        }
        ...
        public void InchToCm(int inches)
        {
            double cm = inches * 2.54;
            q4Output.Text = $"{inches} inches is {cm} centimeters";
        }
    }
}
